...
const CommentSection = ({
  ...
  return (
    <Container
      className={`w-full h-screen overflow-y-auto bg-background fixed top-16 space-y-8 pb-16 transform transition-all duration-700 ${
        showComments
      ...
      width='3xl'
    >
      <div className='flex gap-3 items-center sticky -top-5 left-0 bg-background z-10 py-2'>
        <Button
          isIconOnly
          type='button'
        ...
        : randomPeople?.map((each: any, index: number) => (
            <div key={index} className='space-y-4'>
              ...
              <p className='text-sm'>
                ...
                modi dolorem dolore, optio deleniti necessitatibus iure,
                repellendus possimus, dolores culpa soluta itaque vel? Amet.
              </p>
            </div>
          ))}
    </Container>
